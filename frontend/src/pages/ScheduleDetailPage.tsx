        ...
        <div className={styles.detailTopRow}>
          <div>
            ...
            <div className={styles.headerMetaRow}>
              <div className={styles.metaItem}><span className={styles.metaLabel}>Owner</span><span className={styles.metaValue}>{schedule.owner_user_id}</span></div>
          ...
          {activeTab === 'OVERVIEW' && (
            <div className={styles.fieldStack}>
              ...
              <div className={styles.dlGrid}>
                <div><div className={styles.dlLabel}>Workflow</div><div className={styles.dlValue}>{schedule.workflow_id}</div></div>
